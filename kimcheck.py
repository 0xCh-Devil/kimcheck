...
def banner():
 ...
 (   `                       ` .'     ,'-,'     |  ,;   ;   '' 
  `                           `:     |---|      `.     ,'
                               ...
                               :     `.--`.       '.   : 
                               `      `    `       ',`__)
                             >>> Powerful Penetration Testing Tools <<< \033[91m
                       Script Name : kimcheck V 0.7 \033[92m
                 Developed By : kimazr \033[96m
 ...
 try :
    ...
    while page <= 50 :
      ...
      page +=1
        ...
        pass
def abt():
	print "Script Name : kimcheck " + __version__ + "\033[91m"
	print "Script by: " kimazr__ + "\033[96m"
def getcnfwp(fn):
...
def main():
	...
	banner()
	options()
	kimcheck = raw_input("\033[91mroot@kimazr:~# ")
	if kimcheck == "1":
